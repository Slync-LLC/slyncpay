...
import { engagementTemplateRoutes } from "./routes/engagement-templates.js";
...
app.route("/v1/worksites", worksiteRoutes);
app.route("/v1/engagement-templates", engagementTemplateRoutes);
